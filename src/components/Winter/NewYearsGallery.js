...
const Gallery = () => {
    ...
    try {
        ...
        const imagesContext = require.context('../../Assets/Images/Winter/NewYears', false, /\.(jpg|jpeg|png|gif)$/);
        ...
        console.error(`Error loading images from folder: New Years`, error);
    }
    ...
    return (
        <div className="gallery-container">
            {images.length > 0 ? (
                ...
                <p>No images found for the folder "New Years".</p>
            )}
