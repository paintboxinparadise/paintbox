...
const Gallery = () => {
    ...
    try {
        ...
        const imagesContext = require.context('../../Assets/Images/Summer/FourthOfJuly', false, /\.(jpg|jpeg|png|gif)$/);
        ...
        console.error(`Error loading images from folder: 4th Of July`, error);
    }
    ...
    return (
        <div className="gallery-container">
            {images.length > 0 ? (
                ...
                <p>No images found for the folder "4th Of July".</p>
            )}
